use crate::{
    components::{ActiveClosure, CreatedNode, Component},
    v_dom::v_node,
    /*
    vdom::diff,
    vdom::Patch,
...
pub struct DomUpdater<MSG> {
    ...
    pub current_vdom: v_node::Node<MSG>,
    ...
    MSG: 'static + std::fmt::Debug,
{
    ...
    /// an actual DOM node.
    pub fn mount<DSP>(&mut self, component: std::cell::Ref<DSP>)
    where
        DSP: Component<MSG> + Clone + 'static,
    {
        ...
        self.active_closures.extend(created_node.closures);
