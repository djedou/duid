/*
use crate::{
    components::create_closure_wrap,
    dom::Cmd, 
...
impl Window {
    ...
    pub fn set_title(title: &str) {
        crate::dom::util::document().set_title(title);
    }
        ...
        APP: Application<MSG> + 'static,
    {
        let cmd: Cmd<APP, MSG> = Cmd::new(move |program| {
            ...
            crate::dom::util::window().set_onhashchange(Some(
    ...
    pub fn get_size() -> (i32, i32) {
        let window = crate::dom::util::window();
        ...
        MSG: 'static,
    {
        Cmd::new(|_program| {
            ...
            options.top(0.0);
            options.left(0.0);
            crate::dom::util::window().scroll_to_with_scroll_to_options(&options);
        })
    }
