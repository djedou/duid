...
pub(crate) fn box_shadow() -> HashMap<String, String> {
    ...
    let _ = box_shadow.insert("shadow-btn-focus".to_owned(), "box-shadow: inset 0 0 0 3px var(--tw-shadow-color);".to_owned());
    let _ = box_shadow.insert("shadow-btn-active".to_owned(), "box-shadow: var(--tw-shadow-color);".to_owned());
    let _ = box_shadow.insert("shadow-btn-default".to_owned(), "box-shadow: var(--tw-shadow-color), var(--tw-inset-shadow-color);".to_owned());
    let _ = box_shadow.insert("shadow-btn-filled".to_owned(), "box-shadow: var(--tw-shadow-color), var(--tw-inset-shadow-color);".to_owned());
    let _ = box_shadow.insert("shadow-btn-filled-selected".to_owned(), "box-shadow: var(--tw-shadow-color);".to_owned());
    let _ = box_shadow.insert("shadow-btn-outline-hover".to_owned(), "box-shadow: var(--tw-shadow-color), var(----tw-inset-shadow-color);".to_owned());
    let _ = box_shadow.insert("shadow-btn-outline-selected".to_owned(), "box-shadow: var(--tw-shadow-color);".to_owned());
